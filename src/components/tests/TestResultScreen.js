		...
		return (
			<View style={styles.container}>
				<View style={styles.testItemTop}>
					<View style={styles.levelResultBox}>
						<Text style={styles.levelScoreTitle}>{this.formatScore(this.props.testScore)}</Text>
					</View>
				</View>

				<View style={styles.testItemBody}>
					<Text style={styles.levelText}>{this.getLevelResultText(this.props.testScore)}</Text>
				</View>
